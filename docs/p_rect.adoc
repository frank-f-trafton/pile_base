...
Dependencies: xref:p_assert.adoc[pAssert], xref:p_math.adoc[pMath], xref:p_name.adoc[pName]
...
* `a`: The reference xref:p_rect.adoc#_rectangle[Rectangle].
...
* `a`: The source xref:p_rect.adoc#_rectangle[Rectangle].
...
* `r`: The xref:p_rect.adoc#_rectangle[Rectangle] to expand.
...
* `r`: The xref:p_rect.adoc#_rectangle[Rectangle] to change.
...
Expands a Rectangle by shifting its sides. Like xref:p_rect.adoc#_prect_expand[pRect.expand], but takes a SideDelta.
...
* `sd`: The xref:p_rect.adoc#_sidedelta[SideDelta] to use.
...
* `...`: A vararg list of xref:p_rect.adoc#_rectangle[Rectangles].
...
Gets the horizontal and vertical ranges of a group of Rectangles. Like xref:p_rect.adoc#_prect_getbounds[pRect.getBounds], but takes an array instead of a vararg list.
...
* `list`: An array of xref:p_rect.adoc#_rectangle[Rectangles].
...
* `r`: The xref:p_rect.adoc#_rectangle[Rectangle] to check.
...
Shortens a Rectangle by shifting its sides. Like xref:p_rect.adoc#_prect_reduce[pRect.reduce], but takes a SideDelta.
...
* `r`: The xref:p_rect.adoc#_rectangle[Rectangle] to shorten.
...
* `r`: The xref:p_rect.adoc#_rectangle[Rectangle] to modify.
...
* `a`: The input xref:p_rect.adoc#_rectangle[Rectangle].
...
* `a`: The xref:p_rect.adoc#_rectangle[Rectangle] to shorten.
