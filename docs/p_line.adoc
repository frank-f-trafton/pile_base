...
* `a`: The reference xref:p_line.adoc#_linesegment[LineSegment].
...
* `a`: The source xref:p_line.adoc#_linesegment[LineSegment].
...
* `a`: The xref:p_line.adoc#_linesegment[LineSegment] to modify.
...
Expands a LineSegment by shifting its sides.  Like xref:p_line.adoc#_pline_expand[pLine.expand], but takes a LineDelta table.
...
* `ld`: The xref:p_line.adoc#_linedelta[LineDelta] to use.
...
* `...`: A vararg list of xref:p_line.adoc#_linesegment[LineSegments].
...
Gets the range of a group of LineSegments. Like xref:p_line.adoc#_pline_getbounds[pLine.getBounds], but takes an array of LineSegments rather than a vararg list.
...
* `list`: An array of xref:p_line.adoc#_linesegment[LineSegments].
...
* `a`: The xref:p_line.adoc#_linesegment[LineSegment] to check.
...
Shortens a LineSegment by shifting its sides. Like xref:p_line.adoc#_pline_reduce[pLine.reduce], but takes a LineDelta table.
...
* `a`: The input xref:p_line.adoc#_linesegment[LineSegment].
...
* `a`: The xref:p_line.adoc#_linesegment[LineSegment] to shorten.
