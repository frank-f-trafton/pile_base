...
This function allocates a temporary table. To convert single code points, xref:p_utf8.adoc#_putf8_stringfromcode[pUtf8.stringFromCode] may be used instead.
